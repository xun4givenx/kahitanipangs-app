...
const tones: Record<string, { background: string; color: string; shadow: string }> = {
  ...
  "Home improvement": { background: "#f1e9ff", color: "#8b66c7", shadow: "rgba(139, 102, 199, .16)" },
  ...
  "Loans out": { background: "#e6f3ff", color: "#527fb8", shadow: "rgba(82, 127, 184, .16)" },
  "Cash advances": { background: "#e7f7ed", color: "#4d9a70", shadow: "rgba(77, 154, 112, .16)" },
  Laundry: { background: "#e9f3ff", color: "#6383ba", shadow: "rgba(99, 131, 186, .16)" },
  "Pet care": { background: "#fff0e4", color: "#bd7a4b", shadow: "rgba(189, 122, 75, .16)" },
